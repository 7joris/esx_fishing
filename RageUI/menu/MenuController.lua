            ...
            if CurrentMenu.Open then
                ...
                if not IsInputDisabled(2) then
                    for Index = 1, #Controls.Enabled.Controller do
                        local key = Controls.Enabled.Controller[Index]
                        if (CurrentMenu.disableKeys ~= nil and CurrentMenu.disableKeys[key[2]] == nil) and (RageUI.disabledKeys  ~= nil and  RageUI.disabledKeys[key[2]] == nil) and (not RageUI.disabledKeys['all']) then
                            EnableControlAction(key[1], key[2], true)
                        end
                    end
                else
                    for Index = 1, #Controls.Enabled.Keyboard do
                        local key = Controls.Enabled.Keyboard[Index]
                        if (CurrentMenu.disableKeys ~= nil and CurrentMenu.disableKeys[key[2]] == nil) and (RageUI.disabledKeys  ~= nil and  RageUI.disabledKeys[key[2]] == nil) and (not RageUI.disabledKeys['all']) then
                            EnableControlAction(key[1], key[2], true)
                        end
                    end
                ...
                if Controls.Up.Enabled then
                    for Index = 1, #Controls.Up.Keys do
                        local key = Controls.Up.Keys[Index]
                        if (CurrentMenu.disableKeys ~= nil and CurrentMenu.disableKeys[key[2]] == nil) and (RageUI.disabledKeys  ~= nil and RageUI.disabledKeys[key[2]] == nil) and (not RageUI.disabledKeys['all']) then
                ...
                if Controls.Down.Enabled then
                    for Index = 1, #Controls.Down.Keys do
                        local key = Controls.Down.Keys[Index]

                        if (CurrentMenu.disableKeys ~= nil and CurrentMenu.disableKeys[key[2]] == nil) and (RageUI.disabledKeys ~= nil and RageUI.disabledKeys[key[2]] == nil) then
