        ...
        if CurrentMenu ~= nil then
            if CurrentMenu() then
                ...
                if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                    ...
                    local BadgeArgs = Style.BadgeArgs == nil and nil or Style.BadgeArgs
                    local RightOffset = 0
                    ---@type boolean
                            ...
                            if type(Style) == 'table' then
                                if Style.LeftBadge ~= nil then
                                    if Style.LeftBadge ~= RageUI.BadgeStyle.None then
                                        ...
                                        RenderSprite(BadgeData.BadgeDictionary or "commonmenu", BadgeData.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0,
                                                (BadgeArgs ~= nil and BadgeArgs.BadgeColour ~= nil and BadgeArgs.BadgeColour.R) or BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255,
                                                (BadgeArgs ~= nil and BadgeArgs.BadgeColour ~= nil and BadgeArgs.BadgeColour.G) or BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255,
                                                (BadgeArgs ~= nil and BadgeArgs.BadgeColour ~= nil and BadgeArgs.BadgeColour.B) or BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                    end
                                end
